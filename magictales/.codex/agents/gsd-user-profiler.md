...
<reference>
@/Users/sam/skunkworks/magictales/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/sam/skunkworks/magictales/.codex/gsd-core/references/user-profiling.md` to load:
