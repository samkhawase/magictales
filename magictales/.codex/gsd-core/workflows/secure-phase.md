...
```
Agent(
  prompt="Read /Users/sam/skunkworks/magictales/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/sam/skunkworks/magictales/.codex/gsd-core/templates/SECURITY.md`
