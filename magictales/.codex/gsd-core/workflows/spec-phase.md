...
ones). Reference: @/Users/sam/skunkworks/magictales/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/sam/skunkworks/magictales/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/sam/skunkworks/magictales/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/sam/skunkworks/magictales/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/sam/skunkworks/magictales/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/sam/skunkworks/magictales/.codex/gsd-core/templates/spec.md.
