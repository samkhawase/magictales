...
INSTALL_JS_GLOBAL="/Users/sam/skunkworks/magictales/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/sam/skunkworks/magictales/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
