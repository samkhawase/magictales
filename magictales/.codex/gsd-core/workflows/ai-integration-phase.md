...
<required_reading>
@/Users/sam/skunkworks/magictales/.codex/gsd-core/references/ai-frameworks.md
@/Users/sam/skunkworks/magictales/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/sam/skunkworks/magictales/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/sam/skunkworks/magictales/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/sam/skunkworks/magictales/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/sam/skunkworks/magictales/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/sam/skunkworks/magictales/.codex/agents/gsd-eval-planner.md for instructions.
