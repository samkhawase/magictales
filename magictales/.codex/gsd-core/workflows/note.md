...
- **Global scope**: `/Users/sam/skunkworks/magictales/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sam/skunkworks/magictales/.codex/notes/`)
...
2. Glob `/Users/sam/skunkworks/magictales/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sam/skunkworks/magictales/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sam/skunkworks/magictales/.codex/notes/` — works in any directory
