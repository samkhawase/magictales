...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/sam/skunkworks/magictales/.codex/.gsd-surface.json`
(sibling to `/Users/sam/skunkworks/magictales/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/sam/skunkworks/magictales/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`/Users/sam/skunkworks/magictales/.codex/skills`).
...
`/Users/sam/skunkworks/magictales/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/sam/skunkworks/magictales/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/sam/skunkworks/magictales/.codex/.gsd-surface.json`
Install profile marker: `/Users/sam/skunkworks/magictales/.codex/.gsd-profile`
Skill dirs: `/Users/sam/skunkworks/magictales/.codex/skills/gsd-*/`
Engine module: `/Users/sam/skunkworks/magictales/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/sam/skunkworks/magictales/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
